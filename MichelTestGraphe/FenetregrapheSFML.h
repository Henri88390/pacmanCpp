...
Vecteur2D A(arete->debut->v.p), B(arete->fin->v.p);	// {AB] est l'arête à représenter
...
//----------------------------------------------------------------------------------
/**
par rapport à la classe de base, cette fenêtre dessine en plus les axes du repère monde
...
public:
	...
	largeur : largeur de la fenêtre écran (en pixels)
	hauteur : hauteur de la fenêtre écran (en pixels)
	font1 : police à utiliser pour les annotations sur les sommets
	font2 : police à utiliser pour les annotations sur les axes du repère
	*/
